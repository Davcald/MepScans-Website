...
const contactInfo = [
  ...
  },
  {
    icon: EnvelopeIcon,
    title: 'Email',
    content: 'info@mepscans.com',
    link: 'mailto:info@mepscans.com'
  },
  {
    icon: MapPinIcon,
    title: 'Office',
                ...
                <div className="space-y-6">
                  {contactInfo.map((info, index) => (
                    <motion.a
                      ...
                      className="flex items-start space-x-4 p-4 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                    >
                      <info.icon className="h-6 w-6 text-blue-600 dark:text-blue-400 flex-shrink-0" />
                      <div>
